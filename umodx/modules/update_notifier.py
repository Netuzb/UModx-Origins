...
@loader.tds
class UModxUpdateNotifierMod(loader.Module):
    """Tracks latest umodx releases, and notifies you, if update is required"""

    strings = {
        "name": "UpdateNotifier",
        "update_required": (
            "🌘 <b>umodx Update available!</b>\n\nNew umodx version released.\n🔮"
            " <b>umodx <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 And {} more...</b></i>",
    }
    ...
    strings_ru = {
        "update_required": (
            "🌘 <b>Доступно обновление umodx!</b>\n\nОпубликована новая версия umodx.\n🔮"
            " <b>umodx <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 И еще {}...</b></i>",
    }
    ...
    async def client_ready(self):
        ...
        self._markup = self.inline.generate_markup(
            [
                {"text": "🔄 Update", "data": "umodx_update"},
                {"text": "🚫 Ignore", "data": "umodx_upd_ignore"},
            ]
        )
