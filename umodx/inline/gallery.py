    ...
    async def gallery(
        ...
        *,
        ...
        :param gif: Whether the gallery will be filled with gifs. If you omit this argument and specify
                    gifs in `next_handler`, umodx will try to determine the filetype of these images
        :param manual_security: By default, umodx will try to inherit inline buttons security from the caller (command)
        ...
        with contextlib.suppress(AttributeError):
            _umodx_client_id_logging_tag = copy.copy(self._client.tg_id)
